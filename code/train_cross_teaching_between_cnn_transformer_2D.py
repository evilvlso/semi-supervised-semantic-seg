...
from dataloaders.dataset import (BaseDataSets, RandomGenerator,OwnBaseDataSets,
                                 TwoStreamBatchSampler)
from networks.net_factory import net_factory
from networks.vision_transformer import SwinUnet as ViT_seg
from utils import losses, metrics, ramps
from val_2D import test_single_volume,test_throat_single_volume

parser = argparse.ArgumentParser()
parser.add_argument('--root_path', type=str,
                    default='../data/throat', help='Name of Experiment')
parser.add_argument('--exp', type=str,
                    default='throat/Cross_Teaching_Between_CNN_Transformer', help='experiment_name')
        ...
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            if iter_num > 0 and iter_num % 200 == 0:
                ...
                for i_batch, sampled_batch in enumerate(valloader):
                    metric_i = test_throat_single_volume(
